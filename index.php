<?php $title = "Web Design Plymouth | Website Designers Plymouth | Maciej Szelag Web Developer Plymouth"; include "includes/head.php";?>
...
<main class="main">
    <div class="container">
        <div class="container-wrap" id="home">
            <?php $header_title = "Creative world"; $class_arrow = "arrow-down"; include "includes/header.php";?>
            <div class="content">
            ...
            <div class="content">
                ...
                <div class="h1-title-section-wrap">
                        <h1 class="right-h1 mk-1">What I do?</h1>
                        <h1 class="right-h1 mk-2">What I do?</h1>
                    </div>              
                </div>
            </div>
            <div class="content">
            ...
            <div class="content">
                <div class="img-txt-wrap flex-reverse-2 bx">
                    <div class="img-txt_img">
                        <div class="img-wrap">
            ...
            <div class="content">
                <div class="page-txt-img bg-grey-light bx ">
                <div class="h1-title-section-wrap">
                        <h1 class="right-h1 mk-1">Who am I?</h1>
                        <h1 class="right-h1 mk-2">Who am I?</h1>
                    </div>              
                </div>
            </div>
            <div class="content">
                <div class="page-txt-img bx">                       
                    <div class="img-txt_txt">
                        <p class="txt-p1">I am Maciej and I live in Plymouth, UK,
                            I create beautiful websites at affordable rates for businesses and individuals of all shapes and sizes.  Any website I design and develop is fully responsive, SEO optimised, making sure that your online presence helps you stand our amongst your competitiors.
                        </p>
                            <p class="txt-p1">
                           I'm extremely dedicated to designing and developing the absolute best websites I possible can, for clients like you. Websites that don't only look beautiful but function as they should! 
                            </p>
                </div>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <div class="page-txt-img bg-grey-light bx ">
                <div class="h1-title-section-wrap">
                        <h1 class="right-h1 mk-1">Contact me</h1>
                        <h1 class="right-h1 mk-2">Contact me</h1>
                    </div>
                        <div class="text-wrap ">
                            <p class="p-small">Fill in the form for a free no obligation quote. Or you can chat with me now, email me on
                            <br> <a href="mailto:contact@msweb.co.uk ">contact@msweb.co.uk</a> </p>
                        </div>
                </div>
            </div>
